...
export const MAX_TURNS_AGENT = process.env.MOLCAJETE_MAX_TURNS_AGENT ?? "400";
export const BUDGET_AGENT = process.env.MOLCAJETE_BUDGET_AGENT ?? "15.00";
export const TIMEOUT = parseInt(process.env.MOLCAJETE_TASK_TIMEOUT ?? "1500", 10) * 1000;
export const MAX_DEV_CYCLES = 4;
